...
export const getTasksAssignedToMe = () => api.get('/tasks/assigned-to-me');
export const getTasksInProject = (projectId) => api.get(`/tasks?projectId=${projectId}`);
export const getTasksSupervisedByMe = () => api.get('/tasks/supervised-by-me');
export const updateTaskStatus = (taskId, data) => api.patch(`/tasks/${taskId}/status`, data);
