...
export default function DeleteEmployeeModal({ isOpen, onClose, onConfirm, employee }) {
    console.log("DeleteEmployeeModal render - isOpen:", isOpen, "employee:", employee?.id);
    
    useEffect(() => {
        console.log("DeleteEmployeeModal effect - isOpen changed to:", isOpen);
    }, [isOpen]);
